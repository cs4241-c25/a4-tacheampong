 ...
 if (isMounted){
    {
        return (
            <div>
                <h2 id="welcome" className="text-3xl"></h2>
                    ...
                    <div className="store-container">
                        ...
                        <div className="store">
                            ...
                            <form id="purchase-form" method="post">
                                ...
                                <select defaultValue={"text"} onChange={(event) => updateFields(event.target.value)} name="recipient-list-1" id="recipient-list">
                                    <option value="text" disabled >Select an Option</option>

                                    {data?.purchases && data.purchases.length > 0 ?(
                                        data.purchases.map((purchase: {recipient, gift, quantity, cost, total}, index) => (
